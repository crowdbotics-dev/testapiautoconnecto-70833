...
## Project Structure
    ...
    ├── testapiautoconnecto_70833  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_70833`
...
2. Clone this repo and `cd testapiautoconnecto_70833`
